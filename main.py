...
animal_list = {
    ...
    "mouse": ('"I am small and have a short brown tail"',
              '"I am only attracted to cheeeese!"'),
    "skunk":
    ('"I am mostly black"', '"If you scare me, your nose will regret it"'),
    "tiger": ('"You can sometimes see me in trees"',
              '"I do have black stripes, but am mostly another color"'),
    ...
    "camel": ('"I eat a lot of leaves and grass but not a lot of water"',
              '"I have a hump or two"'),
    "penguin":
    ('"I have webbed feet and wings"', '"I love it when it is cold"'),
    "monkey":
    ('"I love playing in trees"', '"I make funny faces when kids look at me"'),
    "kangaroo":
    ('"I jump so much and its hard to stop"', '"I carry my baby in my pouch"'),
    "turtle": ('"I hide my head if I am shy"', '"My home is always with me"'),
    "buffalo": ('"I am heavy and hairy"',
                '"I was an animal whose parts were not wasted when eaten"'),
    "caterpillar": ('"I have many legs"',
                    '"Once I turn older, I will be able to fly"'),
    "cat": ('"I am furry and very gentle"', '"I am a common pet for people"'),
    "cow": ('"You sometimes see me when traveling"',
            '"Without me, your bones will be brittle"'),
    "jellyfish": ('"I do sting sometimes"', '"I live in the water"'),
    "butterfly": ('"I fly around unpredictably"',
                  '"I live landing on flowers"'),
    "octopus": ('"I have a big head"', '"I have 8 \'legs\'"'),
    "squid": ('"My eye can sometimes be the size of a dinner plate"',
              '"I shoot out ink when I get startled"'),
...
sports_list = {
    ...
    "lions": ('"I am supposed to be ferocious, but I am not in the NFL"',
              '"I am the king of the jungle"'),
    "broncos": ('"I am only relevant because of my QB"',
                '"There is a car named after me"'),
    "chargers":
    ('"I have no fans"', '"I am part of a city that hosts 2 teams"'),
    "raiders":
    ('"Our team is full of controversies"', '"We have a very fast player"'),
    "cowboys": ('"We are over valued"', '"I am the team of America"'),
    "cardinals": ('"I fly"', '"Calamari"'),
    "patriots":
    ('"Everyone hates us cuz of our success"', '"I <3 deflated balls"'),
    "ravens": ('"I run so much and its hard to stop"',
               '"I am a regular season god"'),
    ...
    "jaguars":
    ('"My uniforms are ugly"',
     '"I was only relevant because of my defense a couple years ago"'),
    ...
    "browns": ('"I have more ads than wins"',
               '"My QB beats more women than NFL teams"'),
    "texans": ('"I blew a 24 point lead in the playoffs recently"',
               '"My former coach traded our franchise for a bag of chips"'),
    "panthers": ('"The Falcons ruined our clean slate"',
                 '"My QB did not dive for a fumble"'),
}
